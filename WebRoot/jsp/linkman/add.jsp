					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan=3>
									<%-- <s:select list="customerlist" name="customer.cust_id" headerKey="" headerValue="-请选择-" listKey="key" listValue="value" /> --%>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
									<s:radio list="#{'0':'男','1':'女' }" value="0" name="lkm_gender"></s:radio>
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
