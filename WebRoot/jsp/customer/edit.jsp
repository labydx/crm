...
<BODY>
	<s:actionerror/>
	<s:fielderror/>
	<s:form id="form1" name="form1" action="customer_update" namespace="/"  theme="simple" method="post" enctype="multipart/form-data">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>客户名称：</td>
								<td>
								<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px"
							...
							<TR>
								...
								<td>
								<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px"
								             maxLength="50" name="cust_phone" value="%{model.cust_phone}" />
								</td>
								<td>移动电话 ：</td>
								<td>
								<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px"
								             maxLength="50" name="cust_mobile" value="%{model.cust_mobile}" />
								</td>
							</TR>
							<TR>
