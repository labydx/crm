				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：拜访管理 &gt; 拜访事件列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<td>拜访时间:从</td>
													<td>
														<s:textfield cssClass="textbox" id="datestyle2" readonly="readonly" cssStyle="WIDTH: 180px" maxLength="50" name="visit_time" ></s:textfield>
													</td>
													<td>到</td>
													<td>
														<s:textfield cssClass="textbox" id="datestyle2" readonly="readonly" cssStyle="WIDTH: 180px" maxLength="50" name="visit_end_time" ></s:textfield>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:date format="yyyy-mm-dd" name="visit_time"/></TD>
													<TD><s:property value="visit_addr"/></TD>
													<TD><s:property value="visit_detail"/></TD>
													<TD><s:date format="yyyy-mm-dd" name="visit_nexttime"/></TD>
													
													<TD>
													
													<a href="${pageContext.request.contextPath }/salevisit_editUI.action?visit_id=<s:property value="visit_id"/>">修改</a>
													&nbsp;&nbsp;
