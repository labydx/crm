...
<script type="text/javascript">
	...
	$.get("${pageContext.request.contextPath }/user_findAllUser.action",
		function(data){
			...
			$("#user option[value='%{user.user_id}']").prop("selected","selected"); 
		},"json");
		...
		function(data){
			...
			$("#customer option[value='%{customer.cust_id}']").prop("selected","selected"); 
		},"json");
		//设置日期格式
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：拜访管理 &gt; 修改拜访事件</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间</td>
								<td>
									<s:textfield cssClass="textbox" id="datestyle1" cssStyle="WIDTH: 180px" maxLength="50" name="visit_time" ></s:textfield>
								</td>
								<td>下次拜访时间 ：</td>
								<td>
									<s:textfield cssClass="textbox" id="datestyle2" cssStyle="WIDTH: 180px" maxLength="50" name="visit_nexttime" ></s:textfield>
